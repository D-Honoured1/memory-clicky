  ...
  return (
    <div className="controls">
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <button
          aria-label="Select Easy difficulty - 5 cards"
          onClick={() => setStage(1)}
        ...
        <button
          aria-label="Select Medium difficulty - 10 cards with timer"
          onClick={() => setStage(2)}
        ...
        <button
          aria-label="Select Hard difficulty - 15 cards with timer and auto-shuffle"
          onClick={() => setStage(3)}
      ...
      <div style={{ marginLeft: 12 }} className="small-muted">
        <div>Easy: 5 cards - Take your time</div>
        <div>Medium: 10 cards - 7s time limit per click</div>
        <div>Hard: 15 cards - 5s time limit + auto-shuffle</div>
      </div>
    </div>
  )
}
